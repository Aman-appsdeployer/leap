...
var require_grapesjs_touch_min = __commonJS({
  "node_modules/grapesjs-touch/dist/grapesjs-touch.min.js"(exports, module) {
    !function(e, t) {
      ...
      return function(e) {
        ...
        Object.defineProperty(t, "__esModule", { value: true }), t.default = function() {
          ...
          !function(e3) {
            ...
            var n2 = function() {
              function e4() {
                if (this._lastClick = 0, e4._instance) throw "DragDropTouch instance already created.";
                var t3 = false;
              ...
              return e4.getInstance = function() {
                ...
                if (this._shouldHandle(t3)) {
                  if (Date.now() - this._lastClick < e4._DBLCLICK && this._dispatchEvent(t3, "dblclick", t3.target)) return t3.preventDefault(), void this._reset();
                  this._reset();
                ...
                if (this._shouldHandle(t3)) {
                  ...
                  if (this._dragSource && !this._img) this._getDelta(t3) > e4._THRESHOLD && (this._dispatchEvent(t3, "dragstart", this._dragSource), this._createImage(t3), this._dispatchEvent(t3, "dragenter", n3));
                  if (this._img && (this._lastTouch = t3, t3.preventDefault(), n3 != this._lastTarget && (this._dispatchEvent(this._lastTouch, "dragleave", this._lastTarget), this._dispatchEvent(t3, "dragenter", n3), this._lastTarget = n3), this._moveImage(t3), this._dispatchEvent(t3, "dragover", n3)), this._dispatchEvent(t3, "mousemove", n3)) return this._lastTouch = t3, void t3.preventDefault();
                }
              }, e4.prototype._touchend = function(e5) {
                if (this._shouldHandle(e5)) {
                  if (this._destroyImage(), this._dragSource) return e5.type.indexOf("cancel") < 0 && this._dispatchEvent(this._lastTouch, "drop", this._lastTarget), this._dispatchEvent(this._lastTouch, "dragend", this._dragSource), this._reset(), void e5.preventDefault();
                  if (this._dispatchEvent(this._lastTouch, "mouseup", e5.target)) return void e5.preventDefault();
                ...
                for (; n3 && "none" == getComputedStyle(n3).pointerEvents; ) n3 = n3.parentElement;
                return n3;
                ...
                for (s = 0; s < t3.children.length; s++) this._copyStyle(t3.children[s], n3.children[s]);
                ...
                for (; e5; e5 = e5.parentElement) if (e5.hasAttribute("draggable") && e5.draggable) return e5;
                return null;
              }, e4;
            }();
          ...
          !function() {
            ...
            function u() {
              ...
              this.touchList = e3, this.Touch = function(e4, t3, n3, o2, i2, r2, s2, a2) {
                ...
                var n3;
                for (n3 = 0; n3 < e3.length; n3 += 1) if (e3[n3].identifier === t3) return e3[n3];
              }, this.addUpdateTouch = function(t3) {
                var n3;
                for (n3 = 0; n3 < e3.length; n3 += 1) if (e3[n3].identifier === t3.identifier) return void (e3[n3] = t3);
                e3.push(t3);
              }, this.removeTouch = function(t3) {
                var n3;
                for (n3 = 0; n3 < e3.length; n3 += 1) e3[n3].identifier === t3 && e3.splice(n3, 1);
              }, this.clearTouches = function() {
                for (; e3.length > 0; ) e3.pop();
              }, this.containsTouchAt = function(t3, n3) {
                var o2;
                for (o2 = 0; o2 < e3.length; o2 += 1) if (e3[o2].screenX === t3 && e3[o2].screenY === n3) return true;
                return false;
              };
            }
            function d(e3, t3) {
            ...
            function l(o2, r2, s2, a2, c2) {
              ...
              function f2(e3, t3) {
                var o3, i2;
                for (n2.clearTouches(), o3 = 0; o3 < t3.length; o3++) (i2 = t3[o3]).target.isSameNode(e3) && n2.addUpdateTouch(i2);
              }
              "pointerdown" !== o2.type && (l2 = e2.getTouch(o2.pointerId), p2 = l2.target, o2.target = p2), (u2 = "pointerdown" === o2.type || "pointermove" === o2.type ? function(o3) {
                var r3, s3, a3;
                if (T("touch!"), "pointerdown" === o3.type) r3 = "touchstart";
                else {
                  if ("pointermove" !== o3.type) throw new Error("touchHandler received invalid event type: " + r3 + ". Valid event types are pointerdown and pointermove");
                  r3 = "touchmove";
                }
                return T(r3), s3 = new e2.Touch(o3.pointerId, "pointerdown" === o3.type ? o3.target : p2, o3.screenX, o3.screenY, o3.clientX, o3.clientY, o3.pageX, o3.pageY), o3.hwTimestamp > i && function() {
                  var n3, o4, i2, r4, s4;
                  for (o4 = t2.touchList, n3 = 0; n3 < o4.length; n3 += 1) s4 = (i2 = o4[n3]).identifier, (r4 = e2.getTouch(s4)) && !d(r4, i2) || t2.removeTouch(s4);
            ...
            function f(e3, t3, n3) {
              ...
              if (T("setTouchAware " + n3 + " " + t3), e3.__handJobjsGlobalRegisteredEvents || (e3.__handJobjsGlobalRegisteredEvents = []), n3) {
                if (void 0 !== e3.__handJobjsGlobalRegisteredEvents[t3]) return void (e3.__handJobjsGlobalRegisteredEvents[t3] += 1);
                e3.__handJobjsGlobalRegisteredEvents[t3] = 1, T(e3.__handJobjsGlobalRegisteredEvents[t3]);
              } else void 0 !== e3.__handJobjsGlobalRegisteredEvents[t3] && (e3.__handJobjsGlobalRegisteredEvents[t3] -= 1, e3.__handJobjsGlobalRegisteredEvents[t3] < 0 && (e3.__handJobjsGlobalRegisteredEvents[t3] = 0));
              o2 = l, void 0 !== e3["on" + (i2 = /* @__PURE__ */ function(e4) {
                return e4;
                ...
                if (T("registerOrUnregisterEvent"), void 0 === e4.__handJobjsRegisteredEvents && (e4.__handJobjsRegisteredEvents = []), o3) {
                  if (void 0 !== e4.__handJobjsRegisteredEvents[t4]) return void (e4.__handJobjsRegisteredEvents[t4] += 1);
                  e4.__handJobjsRegisteredEvents[t4] = 1, T("adding event " + t4), e4.addEventListener(t4, n4, false);
                } else {
                  if (-1 !== e4.__handJobjsRegisteredEvents.indexOf(t4) && (e4.__handJobjsRegisteredEvents[t4] -= 1, 0 !== e4.__handJobjsRegisteredEvents[t4])) return;
            ...
            function _(e3) {
              ...
              function n3(e4, n4, o2) {
                -1 !== a.indexOf(e4) && function(e5, t4) {
                  if (void 0 === e5.ontouchdown && void 0 !== e5.ontouchstart) switch (t4.toLowerCase()) {
                    case "touchstart":
            ...
            function y(e3, t3, n3, o2, i2, r2) {
              T("generateTouchEventProxyIfRegistered"), function(e4, t4) {
                for (T("findEventRegisteredNode"); e4 && !m(e4, t4); ) e4 = e4.parentNode;
                return e4 || (m(window, t4) ? window : void 0);
              }(n3, e3) && p(0, t3);
            }
            function E(e3) {
              var t3 = [];
              if (e3) for (t3.unshift(e3); e3.parentNode; ) t3.unshift(e3.parentNode), e3 = e3.parentNode;
              return t3;
            }
            function b(e3, t3) {
              for (var n3 = E(e3), o2 = E(t3), i2 = null; n3.length > 0 && n3[0] === o2.shift(); ) i2 = n3.shift();
              return i2;
            }
            function T(e3) {
            ...
            h.prototype = window.Event.prototype, "object" !== o(window.ontouchstart) && (s.match(/iPad/i) || s.match(/iPhone/i) || s.match(/iPod/i) || s.match(/Android/i) || s.match(/MSIE/i) && !s.match(/Touch/i) || (function() {
              ...
              window.addEventListener("pointerdown", function(e3) {
                ...
                t3(e3) || (c[n3.identifier] = n3.target, y("touchenter", n3, n3.target), function(e4, t4, n4) {
                  ...
                  for (var o2 = b(e4, t4), i2 = e4, r2 = []; i2 && i2 !== o2; ) m(i2, "touchenter") && r2.push(i2), i2 = i2.parentNode;
                  for (; r2.length > 0; ) n4(r2.pop());
                ...
                T("pointer up fired"), t3(e3) || (y("touchend", n3, o2), y("touchleave", n3, o2), function(e4, t4, n4) {
                  ...
                  for (var o3 = b(e4, t4), i2 = e4; i2 && i2 !== o3; ) m(i2, "touchleave") && n4(i2), i2 = i2.parentNode;
                }(o2, null, function(e4) {
                  p(0, n3);
                }));
                ...
                T("pointer move fired"), t3(n3) || (T("x: " + n3.screenX + ", y: " + n3.screenY), e2.containsTouchAt(n3.screenX, n3.screenY) || (i2 && true === function(e3) {
                  for (; e3 && !e3.handJobjs_forcePreventDefault; ) e3 = e3.parentNode;
