...
def list_schools(search: Optional[str] = None, school_id: Optional[int] = None, db: Session = Depends(get_db)):
    base_sql = """
      SELECT
    ...
    if school_id is not None:
        base_sql += " AND school_id_pk = :school_id"
        params["school_id"] = school_id
    elif search:
        base_sql += " AND school_name LIKE :search"
