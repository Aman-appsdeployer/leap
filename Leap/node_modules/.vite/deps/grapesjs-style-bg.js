...
var require_dist = __commonJS({
  "node_modules/grapesjs-style-bg/dist/index.js"(exports, module) {
    !function(e, t) {
      ...
      var e = { 180: function(e2) {
        ...
        "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window && window, t2 = () => (() => {
          var e3 = { 9: function(e4) {
            "undefined" != typeof self && self, e4.exports = function(e5) {
              ...
              Object.defineProperty(t4, "__esModule", { value: true }), t4.on = function(e6, t5, n4) {
                t5 = t5.split(/\s+/);
                for (var r3 = 0; r3 < t5.length; ++r3) e6.addEventListener(t5[r3], n4);
              }, t4.off = function(e6, t5, n4) {
                t5 = t5.split(/\s+/);
                for (var r3 = 0; r3 < t5.length; ++r3) e6.removeEventListener(t5[r3], n4);
              ...
              var o = /* @__PURE__ */ function() {
                ...
                function t5() {
                  ...
                  for (var o2 in r4) o2 in e7 || (e7[o2] = r4[o2]);
                  var i2 = e7.el;
                  if (!((i2 = "string" == typeof i2 ? document.querySelector(i2) : i2) instanceof HTMLElement)) throw "Element not found, given " + i2;
                ...
                return function(e7, t6) {
                  ...
                  if (!this.sandEl && (this.sandEl = document.createElement("div")), !n4 || !r4) return "";
                  for (var o2 = this.sandEl.style, i2 = [r4].concat(function(e8) {
                    if (Array.isArray(e8)) {
                      for (var t7 = 0, n5 = Array(e8.length); t7 < e8.length; t7++) n5[t7] = e8[t7];
                      return n5;
                    }
                  ...
                  for (var e7 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, t6 = this.handlers, n4 = t6.length - 1; n4 >= 0; n4--) t6[n4].remove(e7);
                } }, { key: "getSelected", value: function() {
                  for (var e7 = this.getHandlers(), t6 = 0; t6 < e7.length; t6++) {
                    var n4 = e7[t6];
                    if (n4.isSelected()) return n4;
                  }
                  return null;
              ...
              var r3 = /* @__PURE__ */ function() {
                ...
                function e6() {
                  !function(e7, t5) {
                    if (!(e7 instanceof t5)) throw new TypeError("Cannot call a class as a function");
                  }(this, e6);
                }
                return r3(e6, [{ key: "on", value: function(e7, t5, n4) {
                  ...
                  for (var t5 = [].slice.call(arguments, 1), n4 = ((this.e || (this.e = {}))[e7] || []).slice(), r4 = 0, o2 = n4.length; r4 < o2; r4++) n4[r4].fn.apply(n4[r4].ctx, t5);
                  return this;
                } }, { key: "off", value: function(e7, t5) {
                  var n4 = this.e || (this.e = {}), r4 = n4[e7], o2 = [];
                  if (r4 && t5) for (var i = 0, a = r4.length; i < a; i++) r4[i].fn !== t5 && r4[i].fn._ !== t5 && o2.push(r4[i]);
          ...
          n2.n = (e4) => {
            ...
            for (var r3 in t4) n2.o(t4, r3) && !n2.o(e4, r3) && Object.defineProperty(e4, r3, { enumerable: true, get: t4[r3] });
          ...
          return (() => {
            ...
            var e4 = n2(9), t4 = n2.n(e4), o = function() {
              return o = Object.assign || function(e5) {
                for (var t5, n3 = 1, r3 = arguments.length; n3 < r3; n3++) for (var o2 in t5 = arguments[n3]) Object.prototype.hasOwnProperty.call(t5, o2) && (e5[o2] = t5[o2]);
                return e5;
              }, o.apply(this, arguments);
            }, i = function(e5, t5, n3) {
              if (n3 || 2 === arguments.length) for (var r3, o2 = 0, i2 = t5.length; o2 < i2; o2++) !r3 && o2 in t5 || (r3 || (r3 = Array.prototype.slice.call(t5, 0, o2)), r3[o2] = t5[o2]);
      ...
      return (() => {
        ...
        var a = function(e3) {
          ...
          if (n2.indexOf("url(") > -1) o2[d] = n2;
          else if (n2.indexOf("gradient(") > -1) {
            var i2 = (0, t2.parseGradient)(n2), a2 = i2.stops;
            if (2 === a2.length && "linear" === i2.type && a2[0].color === a2[1].color) o2[s] = e2.Color, o2[p] = a2[0].color;
            else {
